...
export default function RegisterProfesor() {
  ...
  async function handleRegister(e) {
    ...
    setError(""); setOk("");
    try {
      await axios.post(`${API_URL}/api/auth/register`, { email, password, tipo: 2 });
      setOk("Profesor registrado exitosamente, ahora inicia sesión");
  ...
  return (
    <div style={styles.container}>
      ...
      <form onSubmit={handleRegister} style={styles.form} className="register-form">
        <h2 style={styles.h2}>Registro de profesor</h2>
